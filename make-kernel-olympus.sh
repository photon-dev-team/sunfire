...
cp ~/cm9/kernel/tegra-temp/arch/arm/boot/zImage ~/cm9/device/moto/olympus/kernel
cp ~/cm9/vendor/authentec/safenet/vpndriver/vpnclient.ko ~/cm9/device/moto/olympus/modules
cp ~/cm9/vendor/bcm/wlan/osrc/open-src/src/dhd/linux/dhd.ko ~/cm9/device/moto/olympus/modules
